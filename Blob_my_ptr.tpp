#ifndef _Blob_my_ptr_tpp
#define _Blob_my_ptr_tpp
...
//Constructors
template <typename T>
Blob<T>::Blob() : data(my_ptrs::make_shared<std::vector<T>>()) {}

template <typename T>
Blob<T>::Blob(std::initializer_list<T> il):
	data(my_ptrs::make_shared<std::vector<T>>(il)) {}

template <typename T>
Blob<T>::Blob(typename std::vector<T>::iterator b, 
              typename std::vector<T>::iterator e):
	data(my_ptrs::make_shared<std::vector<T>>(b,e))
{}
